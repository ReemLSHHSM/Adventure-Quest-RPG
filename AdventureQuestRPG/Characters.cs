...
namespace AdventureQuestRPG
{
    ...
    {
        public Goblin(string name = "Goblin", int health = 20, int attackPower = 15, int defense = 5)//80,15,5
            : base(name, health, attackPower, defense) { }
    ...
    {
        public Dragon(string name = "Dragon", int health = 20, int attackPower = 3, int defense = 20)//200,30,20
            : base(name, health, attackPower, defense) { }
    ...
    {
        public BossMonster(string name = "Boss Monster", int health = 3, int attackPower = 40, int defense = 2)//300,40,25
            : base(name, health, attackPower, defense) { }
